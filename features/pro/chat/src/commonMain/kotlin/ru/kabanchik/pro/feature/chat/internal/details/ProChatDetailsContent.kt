...
import kabanchik.features.pro.chat.generated.resources.chat_details_hint
...
internal fun ProChatDetailsContent(
    state: ru.kabanchik.pro.feature.chat.api.details.ProChatDetailsContract.State,
    onMessageTextChanged: (String) -> Unit,
    onMessageSent: () -> Unit,
) {
    when (state) {
        _root_ide_package_.ru.kabanchik.pro.feature.chat.api.details.ProChatDetailsContract.State.Loading -> {
            CommonScreenLoader()
        }
        is ru.kabanchik.pro.feature.chat.api.details.ProChatDetailsContract.State.Chat -> {
            _root_ide_package_.ru.kabanchik.pro.feature.chat.internal.details.Chat(
                state = state,
...
@Composable
private fun Chat(
    state: ru.kabanchik.pro.feature.chat.api.details.ProChatDetailsContract.State.Chat,
    onMessageTextChanged: (String) -> Unit,
    onMessageSent: () -> Unit
) {
