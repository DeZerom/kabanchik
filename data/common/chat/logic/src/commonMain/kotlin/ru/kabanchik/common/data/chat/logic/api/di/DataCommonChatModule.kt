...
import ru.kabanchik.common.data.chat.logic.internal.DefaultCommonChatDetailsRepository
...
object DataCommonChatModule {
    val module = module {
        ...
        singleOf(::DefaultCommonChatDetailsRepository) bind CommonChatDetailsRepository::class
    }
}